...
for n = 1:length(yy)
    ...
    [dd0, Hsw0] = GetMagnetosomeLine(Hcr, y, e, d, N, yy(n), 1.0, 10); 
    [dd1, Hsw1] = GetMagnetosomeLine(Hcr, y, e, d, N, yy(n), 1.1, 10); 
    [dd2, Hsw2] = GetMagnetosomeLine(Hcr, y, e, d, N, yy(n), 1.2, 10); 
    [dd3, Hsw3] = GetMagnetosomeLine(Hcr, y, e, d, N, yy(n), 1.3, 10); 
    [dd4, Hsw4] = GetMagnetosomeLine(Hcr, y, e, d, N, yy(n), 1.4, 10); 
    ...
    ylabel('Coercivity or Remanence H_{cr} (mT)'); 
