function [M, H, Mvec, Mr, Hc, Hsw, spec, Hsw_file1, Hsw_file2, Mr_vec] = LoadOneHysteresis(x, y, z, d, N, a, Hinter)
    hys_path = 'D:/magnetosomes/hysteresis'; 
    hys_fine_path = 'D:/magnetosomes/hysteresis_fine'; 
