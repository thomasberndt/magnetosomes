...
for n = 1:length(yy)
    ...
    [dd0, Mr0] = GetMagnetosomeLine(Mr_mean, y, e, d, N, yy(n), 1.0, 10); 
    [dd1, Mr1] = GetMagnetosomeLine(Mr_mean, y, e, d, N, yy(n), 1.1, 10); 
    [dd2, Mr2] = GetMagnetosomeLine(Mr_mean, y, e, d, N, yy(n), 1.2, 10); 
    [dd3, Mr3] = GetMagnetosomeLine(Mr_mean, y, e, d, N, yy(n), 1.3, 10); 
    [dd4, Mr4] = GetMagnetosomeLine(Mr_mean, y, e, d, N, yy(n), 1.4, 10); 
