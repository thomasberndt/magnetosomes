function forccolors = GetForcColors(theme)
    ...
    %     forccolors(52:101,3) = linspace(1, 0, 50).^w; 
        ...
        forccolors(1:500,1) = linspace(0, 1, 500); 
        forccolors(1:500,2) = linspace(0, 1, 500); 
        forccolors(502:1001,2) = linspace(1, 0, 500); 
        forccolors(502:1001,3) = linspace(1, 0, 500); 
    elseif strcmpi(theme, 'roberts')
        forccolors = ones(1001,3); 
        m = -1.5; 
        forccolors(1:500,1) = linspace(m, 0, 500); 
        forccolors(1:500,2) = linspace(m, 0, 500); 
        forccolors(502:701,3) = linspace(0, -0.5, 200); 
        forccolors(702:1001,2) = linspace(0, -1, 300); 
